    ...
    private fun showDialog(permission: String, name: String, requestCode: Int) {
        ...
        builder.apply {
            ...
            setPositiveButton("OK") { dialog, which ->
                ActivityCompat.requestPermissions(this@MainActivitySecond, arrayOf(permission), requestCode)
            }
        }
